  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800 mt-12">
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/jobs" className="text-slate-400 hover:text-cyan-400">
                Browse Jobs
              </Link>

              <Link to="/profile" className="text-slate-400 hover:text-cyan-400">
                Profile
              </Link>

              <Link to="/notifications" className="text-slate-400 hover:text-cyan-400">
                Notifications
              </Link>
        ...
        <div className="flex justify-between flex-wrap gap-4 text-slate-500 text-sm">
