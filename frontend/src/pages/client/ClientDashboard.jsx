          ...
          <>
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                ...
                <Link
                  to="/my-jobs"
                  className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6 hover:border-indigo-500 transition"
                >
                  <p className="text-indigo-400 uppercase text-sm font-semibold">
                    {t("myJobs")}
                  </p>
