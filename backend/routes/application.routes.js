...
import { applyForJob, getJobApplications, getMyApplications, getClientApplications, updateApplicationStatus } from "../controllers/application.controller.js";
import authorizeRoles from "../middleware/role.middleware.js";

const router = express.Router();

router.get("/my", auth, getMyApplications);
router.get("/client",auth, authorizeRoles("client"), getClientApplications);
